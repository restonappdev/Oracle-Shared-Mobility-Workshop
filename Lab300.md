...
## Objectives
- Learn about the update capabilities of Oracle Blockchain.
- Edit chaincode to add new features.
- Install an updated chaincode version onto founder and participant peers.
- Instantiate an updated chaincode version onto two channels.


## Required Artifacts
- The following lab requires a Docker Image of Oracle Blockchain Cloud Service.
- You should have completed labs 100 and 200 of this workshop.
- Have your blockchain network and participants currently running.
- Have the vehicleReg.go chaincode installed and instantiated on the scooter.co and rider.co channels.
...
`git clone TODO: https://github.com/restonappdev/Oracle-Shared-Mobility-Workshop-Artifacts.git`
...
- Navigate down to the next function on line 36 or where you have the “invoke” function declared. “Invoke" is used to call functions so that you can perform business logic with your chaincode. It routes to the correct function based on the “function” parameter.

![](./images/300/Uncomment_Chaincode_0.png)

- You may notice errors on these function names like mine if you opened them using VS Code. No need to worry! It’s only throwing that error because you have the same function names in “tripLogger.go”. It won’t affect the performance of the chaincode when you install and instantiate it.

- Uncomment the “else if” statement online 52 or where yours is declared referring to “getVehiclesNotInService”. It will be enclosed in a blue box. Make sure to NOT to uncomment anything outside of the blue box. 

![](./images/300/Uncomment_Chaincode_00.png)

- Once you do that, insert a tab such that the return statement has the same indentation as the other return statements. Golang utilizes indentation for functionality so this is very important.

![](./images/300/Uncommont_Chaincode_000.png)
...
- Return to the founder organization “CityOfTownship” and navigate to the “Channels” tab. Click on the “riderco.channel” channel as shown below.
