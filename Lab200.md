...
We will start at the service console for the CityOfTownship organization. (If you need to see how to access the consoles for your organizations, see [Lab 100](Lab100.md).) You will open the Chaincodes tab and click the Install Chaincode button.
